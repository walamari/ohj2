...
/**
 *  Luokka, jolla hoidetaan liiga käyttöliittymän tapahtumia.
 * 
...
public class FxliigaGUIController implements Initializable {
    ...
    @FXML private void handleTietoja() {
        Dialogs.showMessageDialog("Tekijät: \n Valtteri & Konsta ");
    }
...
//==================== Ei käyttöliittymään liittyvää suoraa koodia =============================\\
    ...
    /**
     * Tekee tarvittavat alustukset ja vaihtaa Scrollpanen päälle ison teksti alueen, jonka
     * päälle tulostetaan tietoja.
     */
    private void alusta() {
    ...
    /**
     * Näyttää valitun pelaajan käyttöliittymässä
     */
    ...
    /**
     * Näyttää valitun Joukkueen tiedot käyttöliittymässä
     */
    ...
    /**
     * Alustaa liigan lukemalla sen valitun nimisestä tiedostosta
    ...
    /**
     * Luo uuden pelaajan, jolle täytetään halutut tiedot.
     */
   private void uusiPelaaja() {
       ...
       */
       ...
       rek
       //tyyppi.vastaaErikPerrin();   //todo korvaa että aukeaa uusi dialogi
       liiga.lisaa(tyyppi);
       */
   ...
   /**
    * Tekee uuden tyhjän joukkueen muokkaamista varten
   ...
   */
   ...
   /**
    * Tekee uuden tyhjän pelipaikan muokkaamista varten
   ...
   private void hae(int pnr) {
       ...
       chooserPelaajat.getSelectionModel().select(indeksi); // muutosviesti, joka näyttää jäsenen
       
   }
   
   /**
    * Hakee halutun joukkueen tiedot käyttöliittymään 
...
public void tulosta(PrintStream os, Pelaaja pelaaja) {
    ...
    */ 
    private void poistaPelaaja() { 
        ...
        if ( pelaaja == null ) return; 
        if ( !Dialogs.showQuestionDialog("Poisto", "Haluatko poistaa pelaajan: " + pelaaja.getnimi(), "Kyllä", "Ei") ) 
            return; 
